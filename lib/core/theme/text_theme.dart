...
class MyTextTheme {
  ...
  static TextTheme lightTextTheme = TextTheme(
    ...
    displayLarge: const TextStyle().copyWith(fontSize: 20.0, fontWeight: FontWeight.w500, color: Colors.black),
    displayMedium: const TextStyle().copyWith(fontSize: 18.0, fontWeight: FontWeight.w500, color: Colors.black),
    displaySmall: const TextStyle().copyWith(fontSize: 18.0, fontWeight: FontWeight.normal, color: Colors.black),
    ...
    labelMedium: const TextStyle().copyWith(fontSize: 12.0, fontWeight: FontWeight.normal, color: Colors.black.withOpacity(0.8)),
    labelSmall: const TextStyle().copyWith(fontSize: 12.0, fontWeight: FontWeight.normal, color: Colors.grey.shade600),
  );
  ...
  static TextTheme darkTextTheme = TextTheme(
    ...
    displayLarge: const TextStyle().copyWith(fontSize: 20.0, fontWeight: FontWeight.w500, color: Colors.white),
    displayMedium: const TextStyle().copyWith(fontSize: 18.0, fontWeight: FontWeight.w500, color: Colors.white),
    displaySmall: const TextStyle().copyWith(fontSize: 18.0, fontWeight: FontWeight.normal, color: Colors.white),
    ...
    labelMedium: const TextStyle().copyWith(fontSize: 12.0, fontWeight: FontWeight.normal, color: Colors.white.withOpacity(0.8)),
